...
- `Presend_AddressRisk`: check an EVM address (`0x` plus 40 hex characters) against the [OFAC SDN list](https://presend.pages.dev/api) via the Presend address-risk API. No API key.
